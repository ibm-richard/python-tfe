...
class Variables(_Service):
    def list(self, workspace_id: str, options: VariableListOptions | None = None) -> Iterator[Variable]:
    ...
    def list_all(self, workspace_id: str, options: VariableListOptions | None = None) -> Iterator[Variable]:
    ...
    def create(self, workspace_id: str, options: VariableCreateOptions) -> Variable:
        ...
        response = self.t.request("POST", f"/api/v2/workspaces/{workspace_id}/vars", json_body=body)
    ...
    def read(self, workspace_id: str, variable_id: str) -> Variable:
        ...
        response = self.t.request("GET", f"/api/v2/workspaces/{workspace_id}/vars/{variable_id}")
        data = response.json()["data"]
    ...
    def update(self, workspace_id: str, variable_id: str, options: VariableUpdateOptions) -> Variable:
        ...
        response = self.t.request("PATCH", f"/api/v2/workspaces/{workspace_id}/vars/{variable_id}", json_body=body)
        data = response.json()["data"]
    ...
    def delete(self, workspace_id: str, variable_id: str) -> None:
        ...
        self.t.request("DELETE", f"/api/v2/workspaces/{workspace_id}/vars/{variable_id}")
        return None
